...
if __name__ == '__main__':
    ...
    print(classify_image(None,"./server/test/vk18.jpg"))
    print(classify_image(None,"./server/test/msd.jpg"))
    print(classify_image(None,"./server/test/ronaldo.jpg"))
    print(classify_image(None,"./server/test/rs.jpg"))
    print(classify_image(None,"./server/test/ney3.jpg"))
    print(classify_image(None,"./server/test/mbp.jpg"))
